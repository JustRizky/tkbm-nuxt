    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
        ...
        <div class="relative w-48 h-48 mx-auto mb-8">
          <div
            class="absolute inset-0 rounded-full border-[25px] border-blue-600"
            style="clip-path: polygon(50% 50%, 100% 0, 100% 50%)"
          ></div>
          <div
            class="absolute inset-0 rounded-full border-[25px] border-orange-400"
            style="clip-path: polygon(50% 50%, 0 0, 100% 0)"
          ></div>
          <div
            class="absolute inset-0 rounded-full border-[25px] border-rose-600"
            style="clip-path: polygon(50% 50%, 0 0, 0 100%, 100% 100%, 100% 50%)"
          ></div>
        </div>

        <div class="space-y-2">
          <div
            v-for="(color, shift) in {
              'bg-blue-600': 'Shift I',
              'bg-rose-600': 'Shift II',
              'bg-orange-400': 'Shift III'
            }"
            :key="shift"
        ...
        <div class="flex gap-4">
          <div class="flex-1 p-6 bg-slate-50 rounded-xl border border-gray-100">
            ...
            <h4 class="text-sm font-bold text-gray-800 mb-2 leading-tight">
              Bagaimana Generate Jadwal
            </h4>
            <p class="text-[10px] text-gray-500 mb-4">
              Membuat jadwal kerja secara otomatis dan terstruktur
            </p>
            <NuxtLink
              to="#"
              class="text-blue-600 text-[10px] font-bold flex items-center gap-1 uppercase"
            >
              Baca Artikel
